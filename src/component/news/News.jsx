  ...
  const newsData = [
    {
      ...
      date: '2025/06/25',
      title: '３年生歓迎会',
      description: '3年生が12名加わり、徳久研の学生が20名となりました。今年もみんなで焼肉に行きました。これからも賑やかに活動していきます！',
    },
    {
      image: '/~nlplab/news_img/20250324_ait.jpg',
      date: '2025/03/24',
      title: '肥田京佳さんが学生表彰を受賞',
      description: 'YANS2024での受賞が評価され、肥田京佳さんが愛知工業大学令和六年度学生表彰を受賞しました。',
    },
    {
        ...
        <div className={styles.NewsContainer}>
          {newsData.map((newsItem, index) => (
            <div key={index} className={styles.NewsItem}>
              <img src={newsItem.image} alt={`news image ${index + 1}`} width={340} height={230} style={{ objectFit: 'cover' }}/>
